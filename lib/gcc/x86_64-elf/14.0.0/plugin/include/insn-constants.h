...
enum unspec {
  ...
  UNSPEC_TAN = 66,
  UNSPEC_FXAM = 67,
  UNSPEC_FRNDINT_ROUNDEVEN = 68,
  UNSPEC_FRNDINT_FLOOR = 69,
  UNSPEC_FRNDINT_CEIL = 70,
  UNSPEC_FRNDINT_TRUNC = 71,
