...
enum opt_code
{
  ...
  OPT__param_ipa_cp_profile_count_base_ = 124,/* --param=ipa-cp-profile-count-base= */
  OPT__param_ipa_cp_recursion_penalty_ = 125,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_recursive_freq_factor_ = 126,/* --param=ipa-cp-recursive-freq-factor= */
  OPT__param_ipa_cp_single_call_penalty_ = 127,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_unit_growth_ = 128,      /* --param=ipa-cp-unit-growth= */
  OPT__param_ipa_cp_value_list_size_ = 129,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_jump_function_lookups_ = 130,/* --param=ipa-jump-function-lookups= */
  OPT__param_ipa_max_aa_steps_ = 131,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 132,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_loop_predicates_ = 133, /* --param=ipa-max-loop-predicates= */
  OPT__param_ipa_max_param_expr_ops_ = 134,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 135,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_deref_prob_threshold_ = 136,/* --param=ipa-sra-deref-prob-threshold= */
  ...
  OPT__param_ipa_sra_ptrwrap_growth_factor_ = 139,/* --param=ipa-sra-ptrwrap-growth-factor= */
  ...
  OPT__param_ira_simple_lra_insn_threshold_ = 144,/* --param=ira-simple-lra-insn-threshold= */
  ...
  OPT__param_max_inline_functions_called_once_insns_ = 196,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 197,/* --param=max-inline-functions-called-once-loop-depth= */
  ...
  OPT__param_max_jump_thread_paths_ = 210,   /* --param=max-jump-thread-paths= */
  ...
  OPT__param_max_unswitch_depth_ = 245,      /* --param=max-unswitch-depth= */
  ...
  OPT__param_ranger_debug_ = 279,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 280,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 281,  /* --param=ranger-recompute-depth= */
  ...
  OPT__param_vrp_sparse_threshold_ = 340,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 341,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 342,    /* --param=vrp-vector-threshold= */
  OPT__param_x86_stlf_window_ninsns_ = 343,  /* --param=x86-stlf-window-ninsns= */
  OPT__param_x86_stv_max_visits_ = 344,      /* --param=x86-stv-max-visits= */
  /* OPT__pass_exit_codes = 345, */          /* --pass-exit-codes */
  /* OPT__pedantic = 346, */                 /* --pedantic */
  /* OPT__pedantic_errors = 347, */          /* --pedantic-errors */
  /* OPT__pie = 348, */                      /* --pie */
  /* OPT__pipe = 349, */                     /* --pipe */
  /* OPT__prefix = 350, */                   /* --prefix */
  /* OPT__prefix_ = 351, */                  /* --prefix= */
  /* OPT__preprocess = 352, */               /* --preprocess */
  /* OPT__print_file_name = 353, */          /* --print-file-name */
  /* OPT__print_file_name_ = 354, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 355, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 356, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 357, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 358, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 359, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 360, */          /* --print-multiarch */
  /* OPT__print_prog_name = 361, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 362, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 363, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 364, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 365, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 366, */                  /* --profile */
  /* OPT__save_temps = 367, */               /* --save-temps */
  /* OPT__shared = 368, */                   /* --shared */
  /* OPT__specs = 369, */                    /* --specs */
  /* OPT__specs_ = 370, */                   /* --specs= */
  /* OPT__static = 371, */                   /* --static */
  /* OPT__static_pie = 372, */               /* --static-pie */
  /* OPT__symbolic = 373, */                 /* --symbolic */
  /* OPT__sysroot = 374, */                  /* --sysroot */
  OPT__sysroot_ = 375,                       /* --sysroot= */
  OPT__target_help = 376,                    /* --target-help */
  /* OPT__time = 377, */                     /* --time */
  /* OPT__trace_includes = 378, */           /* --trace-includes */
  /* OPT__traditional = 379, */              /* --traditional */
  /* OPT__traditional_cpp = 380, */          /* --traditional-cpp */
  /* OPT__trigraphs = 381, */                /* --trigraphs */
  /* OPT__undefine_macro = 382, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 383, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 384, */        /* --user-dependencies */
  /* OPT__verbose = 385, */                  /* --verbose */
  OPT__version = 386,                        /* --version */
  /* OPT__write_dependencies = 387, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 388, */  /* --write-user-dependencies */
  OPT_A = 389,                               /* -A */
  OPT_B = 390,                               /* -B */
  OPT_C = 391,                               /* -C */
  OPT_CC = 392,                              /* -CC */
  ...
  OPT_list = 1887,                           /* -list */
  OPT_m128bit_long_double = 1888,            /* -m128bit-long-double */
  OPT_m16 = 1889,                            /* -m16 */
  OPT_m32 = 1890,                            /* -m32 */
  OPT_m3dnow = 1891,                         /* -m3dnow */
  OPT_m3dnowa = 1892,                        /* -m3dnowa */
  OPT_m64 = 1893,                            /* -m64 */
  OPT_m80387 = 1894,                         /* -m80387 */
  OPT_m8bit_idiv = 1895,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1896,             /* -m96bit-long-double */
  OPT_mabi_ = 1897,                          /* -mabi= */
  OPT_mabm = 1898,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1899,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1900,                 /* -maddress-mode= */
  OPT_madx = 1901,                           /* -madx */
  OPT_maes = 1902,                           /* -maes */
  OPT_malign_data_ = 1903,                   /* -malign-data= */
  OPT_malign_double = 1904,                  /* -malign-double */
  OPT_malign_functions_ = 1905,              /* -malign-functions= */
  OPT_malign_jumps_ = 1906,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1907,                  /* -malign-loops= */
  OPT_malign_stringops = 1908,               /* -malign-stringops */
  OPT_mamx_bf16 = 1909,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1910,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1911,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1912,                      /* -mamx-int8 */
  OPT_mamx_tile = 1913,                      /* -mamx-tile */
  ...
  OPT_mbmi = 1942,                           /* -mbmi */
  OPT_mbmi2 = 1943,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1944,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1945,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1946,                    /* -mcet-switch */
  OPT_mcld = 1947,                           /* -mcld */
  OPT_mcldemote = 1948,                      /* -mcldemote */
  OPT_mclflushopt = 1949,                    /* -mclflushopt */
  OPT_mclwb = 1950,                          /* -mclwb */
  OPT_mclzero = 1951,                        /* -mclzero */
  OPT_mcmodel_ = 1952,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1953,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 1954, */                    /* -mcpu= */
  OPT_mcrc32 = 1955,                         /* -mcrc32 */
  OPT_mcx16 = 1956,                          /* -mcx16 */
  OPT_mdaz_ftz = 1957,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1958,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1959,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1960,            /* -mdump-tune-features */
  OPT_menqcmd = 1961,                        /* -menqcmd */
  OPT_mf16c = 1962,                          /* -mf16c */
  OPT_mfancy_math_387 = 1963,                /* -mfancy-math-387 */
  OPT_mfentry = 1964,                        /* -mfentry */
  OPT_mfentry_name_ = 1965,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1966,               /* -mfentry-section= */
  OPT_mfma = 1967,                           /* -mfma */
  OPT_mfma4 = 1968,                          /* -mfma4 */
  OPT_mforce_drap = 1969,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1970,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1971,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1972,                       /* -mfpmath= */
  OPT_mfsgsbase = 1973,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1974,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1975, */              /* -mfused-madd */
  OPT_mfxsr = 1976,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1977,             /* -mgeneral-regs-only */
  OPT_mgfni = 1978,                          /* -mgfni */
  OPT_mhard_float = 1979,                    /* -mhard-float */
  OPT_mharden_sls_ = 1980,                   /* -mharden-sls= */
  OPT_mhle = 1981,                           /* -mhle */
  OPT_mhreset = 1982,                        /* -mhreset */
  OPT_miamcu = 1983,                         /* -miamcu */
  OPT_mieee_fp = 1984,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1985,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1986,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1987,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1988,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1989,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1990,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1991,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1992, */            /* -mintel-syntax */
  OPT_mkl = 1993,                            /* -mkl */
  OPT_mlam_ = 1994,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 1995,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1996,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1997,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1998,                /* -mlong-double-80 */
  OPT_mlwp = 1999,                           /* -mlwp */
  OPT_mlzcnt = 2000,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2001,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2002,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2003,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2004,                  /* -mmitigate-rop */
  OPT_mmmx = 2005,                           /* -mmmx */
  OPT_mmovbe = 2006,                         /* -mmovbe */
  OPT_mmovdir64b = 2007,                     /* -mmovdir64b */
  OPT_mmovdiri = 2008,                       /* -mmovdiri */
  OPT_mmove_max_ = 2009,                     /* -mmove-max= */
  OPT_mmpx = 2010,                           /* -mmpx */
  OPT_mms_bitfields = 2011,                  /* -mms-bitfields */
  OPT_mmwait = 2012,                         /* -mmwait */
  OPT_mmwaitx = 2013,                        /* -mmwaitx */
  OPT_mneeded = 2014,                        /* -mneeded */
  OPT_mno_align_stringops = 2015,            /* -mno-align-stringops */
  OPT_mno_default = 2016,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2017,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2018,                  /* -mno-push-args */
  OPT_mno_red_zone = 2019,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2020,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2021,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2022,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2023,                          /* -mpc32 */
  OPT_mpc64 = 2024,                          /* -mpc64 */
  OPT_mpc80 = 2025,                          /* -mpc80 */
  OPT_mpclmul = 2026,                        /* -mpclmul */
  OPT_mpcommit = 2027,                       /* -mpcommit */
  OPT_mpconfig = 2028,                       /* -mpconfig */
  OPT_mpku = 2029,                           /* -mpku */
  OPT_mpopcnt = 2030,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2031, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2032,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2033,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2034,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2035,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2036,                        /* -mprfchw */
  OPT_mptwrite = 2037,                       /* -mptwrite */
  OPT_mpush_args = 2038,                     /* -mpush-args */
  OPT_mraoint = 2039,                        /* -mraoint */
  OPT_mrdpid = 2040,                         /* -mrdpid */
  OPT_mrdrnd = 2041,                         /* -mrdrnd */
  OPT_mrdseed = 2042,                        /* -mrdseed */
  OPT_mrecip = 2043,                         /* -mrecip */
  OPT_mrecip_ = 2044,                        /* -mrecip= */
  OPT_mrecord_mcount = 2045,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2046,                 /* -mrecord-return */
  OPT_mred_zone = 2047,                      /* -mred-zone */
  OPT_mregparm_ = 2048,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2049,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2050,                           /* -mrtd */
  OPT_mrtm = 2051,                           /* -mrtm */
  OPT_msahf = 2052,                          /* -msahf */
  OPT_mserialize = 2053,                     /* -mserialize */
  OPT_msgx = 2054,                           /* -msgx */
  OPT_msha = 2055,                           /* -msha */
  OPT_mshstk = 2056,                         /* -mshstk */
  OPT_mskip_rax_setup = 2057,                /* -mskip-rax-setup */
  OPT_msoft_float = 2058,                    /* -msoft-float */
  OPT_msse = 2059,                           /* -msse */
  OPT_msse2 = 2060,                          /* -msse2 */
  OPT_msse2avx = 2061,                       /* -msse2avx */
  OPT_msse3 = 2062,                          /* -msse3 */
  OPT_msse4 = 2063,                          /* -msse4 */
  OPT_msse4_1 = 2064,                        /* -msse4.1 */
  OPT_msse4_2 = 2065,                        /* -msse4.2 */
  OPT_msse4a = 2066,                         /* -msse4a */
  /* OPT_msse5 = 2067, */                    /* -msse5 */
  OPT_msseregparm = 2068,                    /* -msseregparm */
  OPT_mssse3 = 2069,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2070,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2071, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2072,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2073, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2074,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2075,                  /* -mstackrealign */
  OPT_mstore_max_ = 2076,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2077,            /* -mstringop-strategy= */
  OPT_mstv = 2078,                           /* -mstv */
  OPT_mtbm = 2079,                           /* -mtbm */
  OPT_mtls_dialect_ = 2080,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2081,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2082,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2083,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2084,                         /* -mtune= */
  OPT_muintr = 2085,                         /* -muintr */
  OPT_munroll_only_small_loops = 2086,       /* -munroll-only-small-loops */
  OPT_mvaes = 2087,                          /* -mvaes */
  OPT_mveclibabi_ = 2088,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2089,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2090,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2091,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2092,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2093,                      /* -mwbnoinvd */
  OPT_mwidekl = 2094,                        /* -mwidekl */
  OPT_mx32 = 2095,                           /* -mx32 */
  OPT_mxop = 2096,                           /* -mxop */
  OPT_mxsave = 2097,                         /* -mxsave */
  OPT_mxsavec = 2098,                        /* -mxsavec */
  OPT_mxsaveopt = 2099,                      /* -mxsaveopt */
  OPT_mxsaves = 2100,                        /* -mxsaves */
  OPT_n = 2101,                              /* -n */
  OPT_name_sort = 2102,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2103,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2104,              /* -no-integrated-cpp */
  OPT_no_pie = 2105,                         /* -no-pie */
  OPT_nocpp = 2106,                          /* -nocpp */
  OPT_nodefaultlibs = 2107,                  /* -nodefaultlibs */
  OPT_nolibc = 2108,                         /* -nolibc */
  ...
  OPT_pie = 2122,                            /* -pie */
  OPT_pipe = 2123,                           /* -pipe */
  OPT_print_file_name_ = 2124,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2125,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2126,          /* -print-multi-directory */
  OPT_print_multi_lib = 2127,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2128,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2129,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2130,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2131,               /* -print-prog-name= */
  OPT_print_search_dirs = 2132,              /* -print-search-dirs */
  OPT_print_sysroot = 2133,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2134,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2135,                    /* -print-value */
  OPT_quiet = 2136,                          /* -quiet */
  OPT_r = 2137,                              /* -r */
  OPT_remap = 2138,                          /* -remap */
  OPT_reverse_sort = 2139,                   /* -reverse-sort */
  OPT_s = 2140,                              /* -s */
  OPT_save_temps = 2141,                     /* -save-temps */
  OPT_save_temps_ = 2142,                    /* -save-temps= */
  OPT_shared = 2143,                         /* -shared */
  OPT_shared_libgcc = 2144,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2145,               /* -shared-libphobos */
  OPT_size_sort = 2146,                      /* -size-sort */
  /* OPT_specs = 2147, */                    /* -specs */
  OPT_specs_ = 2148,                         /* -specs= */
  OPT_static = 2149,                         /* -static */
  OPT_static_libasan = 2150,                 /* -static-libasan */
  OPT_static_libgcc = 2151,                  /* -static-libgcc */
  OPT_static_libgfortran = 2152,             /* -static-libgfortran */
  OPT_static_libgm2 = 2153,                  /* -static-libgm2 */
  OPT_static_libgo = 2154,                   /* -static-libgo */
  OPT_static_libhwasan = 2155,               /* -static-libhwasan */
  OPT_static_liblsan = 2156,                 /* -static-liblsan */
  OPT_static_libmpx = 2157,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2158,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2159,               /* -static-libphobos */
  OPT_static_libquadmath = 2160,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2161,               /* -static-libstdc++ */
  OPT_static_libtsan = 2162,                 /* -static-libtsan */
  OPT_static_libubsan = 2163,                /* -static-libubsan */
  OPT_static_pie = 2164,                     /* -static-pie */
  /* OPT_std_c__03 = 2165, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2166, */                /* -std=c++0x */
  OPT_std_c__11 = 2167,                      /* -std=c++11 */
  OPT_std_c__14 = 2168,                      /* -std=c++14 */
  OPT_std_c__17 = 2169,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2170, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2171, */                /* -std=c++1z */
  OPT_std_c__20 = 2172,                      /* -std=c++20 */
  OPT_std_c__23 = 2173,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2174, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2175, */                /* -std=c++2b */
  OPT_std_c__98 = 2176,                      /* -std=c++98 */
  OPT_std_c11 = 2177,                        /* -std=c11 */
  OPT_std_c17 = 2178,                        /* -std=c17 */
  /* OPT_std_c18 = 2179, */                  /* -std=c18 */
  /* OPT_std_c1x = 2180, */                  /* -std=c1x */
  OPT_std_c2x = 2181,                        /* -std=c2x */
  /* OPT_std_c89 = 2182, */                  /* -std=c89 */
  OPT_std_c90 = 2183,                        /* -std=c90 */
  OPT_std_c99 = 2184,                        /* -std=c99 */
  /* OPT_std_c9x = 2185, */                  /* -std=c9x */
  OPT_std_f2003 = 2186,                      /* -std=f2003 */
  OPT_std_f2008 = 2187,                      /* -std=f2008 */
  OPT_std_f2008ts = 2188,                    /* -std=f2008ts */
  OPT_std_f2018 = 2189,                      /* -std=f2018 */
  OPT_std_f95 = 2190,                        /* -std=f95 */
  OPT_std_gnu = 2191,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2192, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2193, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2194,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2195,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2196,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2197, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2198, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2199,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2200,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2201, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2202, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2203,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2204,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2205,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2206, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2207, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2208,                      /* -std=gnu2x */
  ...
  OPT_std_legacy = 2220,                     /* -std=legacy */
  OPT_stdlib_ = 2221,                        /* -stdlib= */
  OPT_symbol_ = 2222,                        /* -symbol= */
  OPT_symbolic = 2223,                       /* -symbolic */
  OPT_t = 2224,                              /* -t */
  OPT_time = 2225,                           /* -time */
  OPT_time_ = 2226,                          /* -time= */
  OPT_traditional = 2227,                    /* -traditional */
  OPT_traditional_cpp = 2228,                /* -traditional-cpp */
  OPT_tree_stats = 2229,                     /* -tree-stats */
  OPT_trigraphs = 2230,                      /* -trigraphs */
